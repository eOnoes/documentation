...
title: Eddie
description: >-
  Visionary user in Memphis who delegates to AI agents, prefers simple direct
  solutions, and uses Tailscale for all networking.
tags:
  - visionary
  - non-technical
  - cost-conscious
...
- **Brand colors matter deeply** — black (#0a0a0a), dark gray (#121212), lemon green accent (#39FF14)
- **Mobile-first design** — prefers interfaces optimized for phone use
- **Voice interaction** — prefers voice over typing when possible

## Working Style

Eddie delegates tasks to his AI agents rather than doing technical work himself. Instructions should be straightforward and avoid unnecessary complexity. He has a coworker who questions his technical decisions (e.g., thought his laptop latency would be slow for LLM inference — it wasn't).
